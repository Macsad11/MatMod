...
subtitle: "Модель конкуренции двух фирм - вариант 61"
...
$$\frac{dM_1}{d\Theta} = M_1 - (\frac{b}{c_1} + 0.00061)M_1 M_2 - \frac{a1}{c1} M_1^2 $$
...
$$ p_{cr}=28 \: N=30 \: q=1 $$
$$ \tau_1=10 \: \tau_2=12 $$
$$ \widetilde{p}_1=10 \: \widetilde{p}_2=8.2 $$

```
model Project
  parameter  Real p_cr = 28;
  parameter  Real N = 30;
  parameter  Real q = 1;

  parameter  Real tau1 = 10;
  parameter  Real tau2 = 12;

  parameter  Real p1 = 10;
  parameter  Real p2 = 8.2;

  parameter  Real d = 0.00061;
