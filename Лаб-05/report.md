...
subtitle: "Модель хищник-жертва - вариант 61"
...
$$
 \begin{cases}
	\frac{dx}{dt} = -0.54x(t) + 0.031y(t)x(t)
	\\   
	\frac{dy}{dt} = 0.62y(t) - 0.07y(t)x(t)
 \end{cases}
$$

Постройте график зависимости численности хищников от численности жертв, а также графики изменения численности хищников и численности жертв 
при следующих начальных условиях: $x_0=10, y_0=30$
...
Стационарное состояние $x_0=\frac{a}{b}=17.419, y_0=\frac{c}{d}=8.857$
