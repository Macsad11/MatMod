...
subtitle: "Модель гармонических колебаний - вариант 61"
...
силы $\ddot{x}+11\dot{x}+7x=0$
3. Колебания гармонического осциллятора c затуханием и под действием внешней
силы $\ddot{x}+12\dot{x}+8x=4\cos{2t}$

На итнтервале $t \in [ 0;39 ]$, шаг 0.05, $x_0=-1, y_0=-0.1$
